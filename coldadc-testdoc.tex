...
\input{sec.2.3}
\subsection{LBNL Test System  [{\color{red} Prakash/Lin}] }
\input{sec.2.4}
...
\subsection{Noise [{\color{red} Gao } ] }
\input{sec.4.1}
...
\input{sec.5.7}
\subsection{Bandgap Voltage Reference (BGR) Op-Amp [{\color{red} Dabrowski/Grace}] }
\input{sec.5.8}
